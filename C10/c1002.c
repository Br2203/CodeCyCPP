...
void printarrint(int *, int);
void printarrfloat(float *, int);
void printarrchar(char *, int);
...
//    t=z;
    ...
    printf("\n");
    printf("ARREGLO COMPLETO z: ");
    printarrint(z,sizeof(z));

    printf("ARREGLO COMPLETO q: ");
    printarrfloat(q,sizeof(q));

    printf("ARREGLO COMPLETO c: ");
    printarrchar(c,sizeof(c));
...
void printarrfloat(float *p, int sz){
    for(int i=1; i<sz/4; i++){
        printf("%.2f ", p[i-1]);
    }
    printf("%.2f\n",p[(sz/4)-1]);
...
void printarrchar(char *p, int sz){
    for(int i=1; i<sz; i++){
        printf("%c", p[i-1]);
    }
    printf("%c\n",p[sz-1]);
